...
/**
 * Second day advent of code 2017 problem.
 */
class CheckSum : Answer {
    override fun showAnswer(): String {
        val input = arrayOf("121	59	141	21	120	67	58	49	22	46	56	112	53	111	104	130",
     ...
     * @param multiline
     */
    fun checksum(lines: Array<String>): Int {
